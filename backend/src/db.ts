...
export async function ensureDatabaseSchema(): Promise<void> {
  ...
  await query(`CREATE INDEX IF NOT EXISTS idx_users_last_login_at ON users(last_login_at DESC)`);
  ...
  await query(`CREATE INDEX IF NOT EXISTS idx_payroll_data_updated_at ON payroll_data(updated_at DESC)`);
  await query(`CREATE INDEX IF NOT EXISTS idx_ip_bans_ip_address ON ip_bans(ip_address)`);
